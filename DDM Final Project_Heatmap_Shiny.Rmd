...
renderPlot({
  ...
  ggplot( data = filtered, aes( x = filtered$weekday, y = filtered$period, fill = count )) + geom_tile() + scale_fill_gradientn( colors=cool.colors,  na.value = "0" )  + labs(title = "January Ridership by Station") + labs( x = "", y = "") + theme( panel.border = element_blank(), 
